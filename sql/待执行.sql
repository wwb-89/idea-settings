...
INSERT INTO `activity_engine`.`t_template_component` (`id`, `pid`, `template_id`, `component_id`, `name`, `introduction`, `is_required`, `sequence`, `is_deleted`, `type`, `data_origin`, `origin_identify`, `field_flag`) VALUES (133, 0, 7, 11, '发布班级', '按照发布班级选择活动范围', 1, 4, 0, NULL, 'interface', 'http://api.hd.chaoxing.com/user/clazz/teaching', NULL);
