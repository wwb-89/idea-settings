...
import com.chaoxing.activity.ActivityWebApplication;
...
public class PathUtils {
    ...
    /** 项目的部署路径 */
    private static final String PROJECT_DEPLOY_PATH = ActivityWebApplication.class.getProtectionDomain().getCodeSource().getLocation().getPath();
