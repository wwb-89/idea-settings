...
public class UserCancelSignInEventQueueService {
    ...
    public void handle(UserCancelSignInEventOrigin eventOrigin) {
        ...
        // 记录用户行为
        UserActionQueue.QueueParamDTO queueParam = new UserActionQueue.QueueParamDTO(uid, activityId, UserActionTypeEnum.SIGN_IN, UserActionEnum.CANCEL_SIGNED_IN, String.valueOf(eventOrigin.getSignInId()), DateUtils.timestamp2Date(eventOrigin.getTimestamp()));
