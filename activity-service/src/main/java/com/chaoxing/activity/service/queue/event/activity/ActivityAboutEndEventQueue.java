...
public class ActivityAboutEndEventQueue implements IDelayedQueue<ActivityAboutEndEventOrigin> {
    ...
    private LocalDateTime getDelayTime(ActivityAboutEndEventOrigin eventOrigin) {
        ...
        LocalDateTime delayTime = endTime.minusHours(delayHour).minusMinutes(delayMinute);
        return delayTime;
    }

    public void rePush(ActivityAboutEndEventOrigin eventOrigin) {
        LocalDateTime delayTime = getDelayTime(eventOrigin);
