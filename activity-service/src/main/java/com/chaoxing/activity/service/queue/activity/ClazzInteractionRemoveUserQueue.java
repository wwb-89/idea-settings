 ...
 * @author wwb
 * @version ver 1.0
 * @className ClazzInteractionRemoveUserQueue
 * @description
 * @blame wwb
 * @date 2021-12-29 18:22:43
 */
@Slf4j
@Service
public class ClazzInteractionRemoveUserQueue implements IQueue<ClazzInteractionRemoveUserQueue.QueueParamDTO> {

    private static final String CACHE_KEY = CacheConstant.QUEUE_CACHE_KEY_PREFIX + "clazz_interaction" + CacheConstant.CACHE_KEY_SEPARATOR + "remove_user";
