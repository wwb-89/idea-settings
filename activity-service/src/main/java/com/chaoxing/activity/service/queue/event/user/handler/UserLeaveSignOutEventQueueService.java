...
public class UserLeaveSignOutEventQueueService {
    ...
    public void handle(UserLeaveSignOutEventOrigin eventOrigin) {
        ...
        // 记录用户行为
        UserActionQueue.QueueParamDTO queueParam = new UserActionQueue.QueueParamDTO(uid, activityId, UserActionTypeEnum.SIGN_OUT, UserActionEnum.LEAVE_SIGNED_OUT, String.valueOf(eventOrigin.getSignOutId()), DateUtils.timestamp2Date(eventOrigin.getTimestamp()));
