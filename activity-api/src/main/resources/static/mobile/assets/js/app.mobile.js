(function(W, $, J, B){
    ...
    /** "我的"图标的地址 */
    app.prototype.my_icon_url = W.location.origin + ctx + "/mobile/assets/images/my.png";
    /** 更多图标的地址 */
    app.prototype.menu_icon_url = W.location.origin + ctx + "/mobile/assets/images/more.png";
    ...
    app.prototype.login = function () {
        B.postNotification('CLIENT_LOGIN', {"loginId": 0});
    };
    /**
     * 获取登录状态
     */
    app.prototype.getLoginInfo = function () {
        B.postNotification("CLIENT_LOGIN_STATUS", {});
    };
    /**
     * 获取自己的用户信息
     * @param callback
