...
public class ErdosActivityInfoApiController {
    ...
    */
    ...
    private List<MhGeneralAppResultDataDTO.MhGeneralAppResultDataFieldDTO> packageBtns(Activity activity, Integer signId, Integer uid, Integer fid, List<Integer> availableFlags) {
        ...
        if (workId != null) {
            // 作品征集定制
            List<MhGeneralAppResultDataDTO.MhGeneralAppResultDataFieldDTO> workBtns = listWorkBtn(uid, fid, workId, getFlag(availableFlags));
            result.addAll(workBtns);
        }
    ...
    private List<MhGeneralAppResultDataDTO.MhGeneralAppResultDataFieldDTO> listWorkBtn(Integer uid, Integer fid, Integer workId, String flag) {
        List<MhGeneralAppResultDataDTO.MhGeneralAppResultDataFieldDTO> btns = Lists.newArrayList();
